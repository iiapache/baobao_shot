...
const adapterName = "TongyiWanxiangAdapter"

// Adapter implements ModelAdapter for Alibaba DashScope Wanxiang image editing (CN).
type Adapter struct {
	cfg    Config
	client Client
}

// NewAdapter creates the CN Tongyi Wanxiang adapter.
...
// Region is always CN for Tongyi Wanxiang.
...
// Invoke translates input, calls Wanxiang, and returns output object keys.
